...
const ProjectCard = ({ data }) => {
  ...
  return (
    <div className="bg-zinc-950/50 max-w-74 flex items-center aspect-256/300  relative rounded-md  my-5 overflow-hidden p-3 hover:bg-zinc-950/90 transition-all duration-300 hover:-translate-y-4 cursor-pointer hover:shadow-xs shadow-black">
      {/* <img
        src={screenshot}
      ...
      <div className="z-3 pt-3 flex flex-col justify-end items-center   text-white p-3">
